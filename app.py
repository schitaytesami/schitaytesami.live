...
def stats_get():
	...
	by_region = lambda stations: [('Регион: Автоматический выбор', -1, [('УИК: Автоматический выбор', -1)])] + [(g[0].station_address.split(',')[0], k, [('УИК: Автоматический выбор', -1)] + by_station(g)) for k, g in groupby(stations, key = lambda s: s.region_number)]
